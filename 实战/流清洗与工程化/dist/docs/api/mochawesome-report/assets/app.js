...
!function (e) {
  ...
  Object.defineProperty(t, "__esModule", {
    ...
    function H(e, t, n, r) {
      ...
      try {
        ...
        !function (e) {
          $(e.prevAllowStateChanges), Yt(), nn(e.prevDerivation), e.notifySpy && b({
    ...
    var Xe = {},
      ...
      return e.prototype._has = function (e) {
        ...
        return Ge(function () {
          var n,
              r = ft(n = e) ? Object.keys(n) : Array.isArray(n) ? n.map(function (e) {
            return e[0];
    ...
    var ln = function () {
      ...
      return e.prototype.onBecomeStale = function () {
        ...
        this._isRunning = !1, this._isTrackPending = !1, this.isDisposed && Jt(this), Gt(r) && this.reportExceptionInDerivation(r.cause), n && b({
          time: Date.now() - t
        }), Yt();
    ...
    function Tn(e, t) {
      return Kt() || console.warn(U("m013")), kn(e, {
        context: t
      }).get();
    }
    ...
    return function (e, t) {
      ...
      value: function () {
        ...
        return a.default.createElement("section", {
          className: A,
          id: v
        }, !L && a.default.createElement("header", {
          className: h("header")
        }, "" !== g && a.default.createElement("h3", {
          className: h("title")
        }, g), "" !== b && a.default.createElement("h6", {
          className: h("filename")
        }, b), x && r && a.default.createElement(l.SuiteChart, R), x && a.default.createElement(l.SuiteSummary, I)), a.default.createElement("div", {
          className: h("body")
        }, (x || S || T) && a.default.createElement(u.TestList, {
          uuid: v,
          tests: d,
          beforeHooks: p,
          afterHooks: m,
  ...
  !function (e) {
    ...
    function m(e) {
      ...
      return function e(n, r) {
        for (var o = n.firstChild; o; o = o.nextSibling) 3 === o.nodeType ? r += o.nodeValue.length : 1 === o.nodeType && (t.push({
          ...
          offset: r,
          node: o
        }), r = e(o, r), f(o).match(/br|hr|img|input/) || t.push({
          event: "stop",
          offset: r,
          node: o
        }));
    ...
    function g(e, t, n, o) {
      ...
      function f(e) {
        x += e.className ? i(e.className, "", !0) : "", y = Object.create(e, {
          parent: {
            value: y
          }
        });
  ...
  var l = document.querySelector("body"),
      ...
      d = new s.default(c, f);
  l.removeAttribute("data-raw"), l.removeAttribute("data-config"), window.marge = d, o.default.render(r.default.createElement(a.MochawesomeReport, {
    store: d
  ...
  ha = function (e, t) {
  ...
  }, ma = function () {}, va = function (e, t, n, r, a) {
    ...
    if (i !== r) {
      ...
      for (n in r) {
        var c = r[n];
        if (l = null != i ? i[n] : void 0, r.hasOwnProperty(n) && c !== l && (null != c || null != l)) if ("style" === n) {
          if (l) {
            for (s in l) !l.hasOwnProperty(s) || c && c.hasOwnProperty(s) || (u || (u = {}), u[s] = "");

            for (s in c) c.hasOwnProperty(s) && l[s] !== c[s] && (u || (u = {}), u[s] = c[s]);
          } else u || (e || (e = []), e.push(n, u)), u = c;
        } else "dangerouslySetInnerHTML" === n ? (c = c ? c.__html : void 0, l = l ? l.__html : void 0, null != c && l !== c && (e = e || []).push(n, "" + c)) : "children" === n ? l === c || "string" != typeof c && "number" != typeof c || (e = e || []).push(n, "" + c) : "suppressContentEditableWarning" !== n && "suppressHydrationWarning" !== n && (y.hasOwnProperty(n) ? (null != c && dr(a, n), e || l === c || (e = [])) : (e = e || []).push(n, c));
      }
  ...
  function ka(e) {
    ...
    for (var o = e;;) {
      if (5 === o.tag || 6 === o.tag) {
        ...
        } else r ? (s = t, u = o.stateNode, 8 === s.nodeType ? (a = s.parentNode).insertBefore(u, s) : (a = s).appendChild(u), null !== (s = s._reactRootContainer) && void 0 !== s || null !== a.onclick || (a.onclick = pr)) : t.appendChild(o.stateNode);
  ...
  function Ca(e, t, n) {
    ...
    return null !== a && "function" == typeof a.componentDidCatch && (n.callback = function () {
      ...
      var n = t.value,
          o = t.stack;
      ya(e, t), this.componentDidCatch(n, {
            ...
            case 5:
              ...
              if (s = t.type, null !== a && null != t.stateNode) va(a, t, s, u, l), a.ref !== t.ref && (t.effectTag |= 128);else if (u) {
                ...
                if (Zo(t)) {
                  ...
                  d = t, a = s, p = u, f = 9 === l.nodeType ? l : l.ownerDocument, c === Zn.html && (c = Jn(a)), c === Zn.html ? "script" === a ? ((a = f.createElement("div")).innerHTML = "<script><\/script>", f = a.removeChild(a.firstChild)) : "string" == typeof p.is ? f = f.createElement(a, {
                    is: p.is
                  }) : (f = f.createElement(a), "select" === a && p.multiple && (f.multiple = !0)) : f = f.createElementNS(c, a), (a = f)[D] = d, a[A] = u, ha(a, t, !1, !1), p = a;
                  var h = l,
                      m = fr(f = s, d = u);
  ...
  function ki(e, t) {
    ...
    oi = t, e = a.unstable_now() - vi, ai = a.unstable_scheduleCallback(Pi, {
  ...
  function Fi(e, t, n, r, o) {
    ...
    return null === t.context ? t.context = n : t.pendingContext = n, t = o, (o = no(r)).payload = {
      element: e
    }, null !== (t = void 0 === t ? null : t) && (o.callback = t), $a(), oo(a, o), ei(a, r), r;
  }
  ...
  var m = c.default.bind(f.default),
    ...
    function t() {
      ...
      return n = r = h(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(a))), r.state = {
        ...
        r.setState({
          open: !1
        }), r.props.onToggle && r.props.onToggle(!1);
      }, r.toggleListDisplay = function () {
        r.setState({
          open: !r.state.open
        }), r.props.onToggle && r.props.onToggle(!r.state.open);
    ...
    function t() {
      ...
      return n = r = p(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(i))), r._getItemText = function (e) {
        ...
        return a.default.createElement("li", {
          ...
          className: E
        }, y) : v ? v(e, y, g) : a.default.createElement("a", {
          className: O,
          href: "",
          onClick: x
        }, y), b && a.default.createElement("ul", {
          className: w
        }, b.map(r._renderMenu)));
      }, p(r, n);
    }
  ...
  m.propTypes = {
    ...
    list: i.default.arrayOf(i.default.shape({
  ...
  function f(e) {
    ...
    }, !!i && r.default.createElement(a.Icon, {
      name: i,
      className: l("icon", s)
    }), !!o && r.default.createElement("span", {
      className: v
    }, o), r.default.createElement(a.Dropdown, {
  ...
  var d = (o = r = function (e) {
    ...
    return function (e, t) {
      ...
      value: function () {
        ...
        return o ? s.default.createElement("span", null, s.default.createElement("span", {
  ...
  var u = a.default.bind(i.default),
    ...
    return r.default.createElement("footer", {
      ...
      className: "container"
    }, r.default.createElement("p", null, "©", n, " ", r.default.createElement("a", {
      href: l,
      target: "_blank",
  ...
  e.exports = {
    "trans-color": "footer--trans-color---3btBs",
    component: "footer--component---3Cile"
  };
}, function (e, t, n) {
  "use strict";
  ...
  var h = f.default.bind(d.default),
    ...
    return function (e, t) {
      ...
      key: "render",
      value: function () {
        return this.props.reportStore.isLoading && u.default.createElement("div", {
  ...
  var c = (0, a.observer)(function (e) {
    ...
    return r.default.createElement(a.Provider, {
      reportStore: e.store
    }, r.default.createElement("main", null, r.default.createElement(i.Navbar, {
      onMenuClick: n,
      reportTitle: o,
      stats: l
    }), r.default.createElement(i.ReportBody, null), r.default.createElement(i.Loader, null), r.default.createElement(i.Footer, {
      version: f
    }), r.default.createElement(s.NavMenu, null), c && r.default.createElement(u.default, {
      position: {
        bottom: 0,
        right: 20
      }
  ...
  }, c.displayName = "MochawesomeReport", t.default = c;
}, function (e, t, n) {
  "use strict";
  ...
  var y = v.default.bind(g.default),
    ...
    return function (e, t) {
      ...
      value: function () {
        ...
        return l.default.createElement("div", {
        ...
        }, l.default.createElement(h.Icon, {
          name: "close"
        })), l.default.createElement("div", {
          className: y("section")
        }, l.default.createElement("h3", {
          className: y("title")
        }, r), l.default.createElement("h6", {
          className: y("date")
        }, (0, d.format)(b.end, "dddd, MMMM D, YYYY h:mma"))), l.default.createElement("div", {
          className: y("section")
          ...
          return l.default.createElement("ul", {
            ...
            return l.default.createElement(m.NavMenuItem, i({
              key: e.uuid,
              suite: e
            }, x));
          }));
    ...
    return function (e, t) {
      ...
      value: function () {
        ...
        return !!t && u.default.createElement("div", null, t.map(function (e) {
          ...
          }, u.default.createElement(f.NavMenuItem, a({
            suite: e
          }, n)));
        }));
      }
      ...
      value: function () {
        var e,
          ...
          showSkipped: c
            ...
            T = y && _ && !x && !w && !k,
            C = g("link", {
          disabled: (e = 0, !y && h && (e += 1), _ && (e += 1), x && (e += 1), w && (e += 1), k && (e += 1), !c && k && (e -= 1), !l && w && (e -= 1), !s && x && (e -= 1), !i && _ && (e -= 1), c || l || s || i || y || (e -= 1), e <= 0)
        });
        ...
        return u.default.createElement("li", {
          ...
          size: 18
        })), u.default.createElement("span", null, "" === v ? m : v)), h && !!h.length && u.default.createElement(p.NavMenuList, a({
          suites: h
        }, b)));
      }
    }]), t;
  ...
  var l = i.default.bind(s.default),
    ...
    return r.default.createElement("div", {
      ...
      className: l("stats")
    }, r.default.createElement(a.QuickSummary, {
      stats: o
    })), f && r.default.createElement("div", {
      className: l("pct-bar")
    }, c && d(s, "pend", "Pending"), !c && d(i, "pass", "Passing"), !c && d(u, "fail", "Failing")));
  };
  ...
  c.propTypes = {
    stats: o.default.object
  }, c.displayName = "QuickSummary", t.default = c;
}, function (e, t) {
  e.exports = {
  ...
  function c(e) {
    ...
    }, !!s && r.default.createElement(a.Icon, {
      name: s,
      className: u
  ...
  c.propTypes = {
    ...
    active: !1
  }, c.displayName = "RadioButton", t.default = c;
}, function (e, t) {
  e.exports = {
  ...
  var h = f.default.bind(d.default),
    ...
    function t() {
      ...
      return e.state = {
        expanded: !1
      }, e.toggleExpandedState = e.toggleExpandedState.bind(e), e;
    }
    ...
    return function (e, t) {
      ...
      value: function () {
        var e = this.props,
            t = e.test;
        (e.enableCode && t.pass || t.context || t.fail || t.isHook) && this.setState({
      ...
      value: function () {
        ...
        return s.default.createElement("section", {
          ...
          className: h("info")
        }, !!_ && s.default.createElement(l.Icon, {
          ...
          size: 18
        }))), !!b.message && s.default.createElement("p", {
          className: h("error-message")
        }, b.message), this.state.expanded && s.default.createElement("div", {
          className: h("body")
          ...
          code: y,
          label: "Test Code"
        }), !!_ && s.default.createElement(c.TestContext, {
          context: _
        })));
      }
    }]), t;
  }(), r.propTypes = {
    test: u.default.object,
    enableCode: u.default.bool
  }, r.defaultProps = {
    enableCode: !0
  }, o);
  t.default = m;
  ...
  var v = d.default.bind(p.default),
    ...
    return function (e, t) {
      ...
      value: function () {
        ...
        }, s.default.createElement("code", null, l && (f ? s.default.createElement("span", {
          className: v("code-diff-actual")
        }, "actual") : s.default.createElement("span", {
          className: v("code-diff-expected")
        }, "+ expected")), l && (f ? s.default.createElement("span", {
          className: v("code-diff-expected")
        ...
        }) : o), !!i && u && s.default.createElement("span", {
          className: v("code-label")
        }, i));
      }
    }]), t;
  ...
  var l = i.default.bind(s.default),
    ...
    return r.default.createElement("div", {
      ...
      return r.default.createElement(a.Test, {
        key: e.uuid,
        test: e,
        enableCode: s
      });
  ...
  var m = f.default.bind(d.default),
    ...
    function t() {
      ...
      return n = r = h(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(a))), r.renderVideo = function (e, t) {
        ...
        var n = {
          className: m("context-item")
        };
        if (void 0 !== t && (n.key = t), (0, c.default)(e)) return s.default.createElement("div", n, r.renderContextContent(e));
        var o = e.title,
            a = e.value;
        return s.default.createElement("div", n, s.default.createElement("h4", {
          className: m("context-item-title")
        }, o, ":"), r.renderContextContent(a, o, !0));
      }, h(r, n);
    }
    ...
    return function (e, t) {
      ...
      value: function () {
        var e = this.props,
            ...
            r = e.totalPending,
            o = e.totalSkipped;
        new c.default.Pie(this.node, {
          series: [t, n, r, o]
        }, {
          classNames: {
            sliceDonutSolid: h("chart-slice")
          },
          chartPadding: 0,
          donut: !0,
          donutSolid: !0,
  ...
  o = this, a = function () {
    ...
    return function (e, t, n) {
      ...
      n.namespaces = {
        ...
        return a.normalized.series = n.getDataArray({
          series: e.series || []
        }, t, r), o = a.normalized.series.every(function (e) {
        ...
        if (h[i.units.pos] = e + u[i.units.pos], h[i.counterUnits.pos] = u[i.counterUnits.pos], h[i.units.len] = r, h[i.counterUnits.len] = Math.max(0, s - 10), f) {
          ...
          m.className = c.join(" "), m.setAttribute("xmlns", n.namespaces.xhtml), m.innerText = a[o], m.style[i.units.len] = Math.round(h[i.units.len]) + "px", m.style[i.counterUnits.len] = Math.round(h[i.counterUnits.len]) + "px", p = l.foreignObject(m, n.extend({
      ...
      n.Svg = n.Class.extend({
        constructor: function (e, r, o, a, i) {
          ...
          })), r && this.attr(r), o && this.addClass(o), a && (i && a._node.firstChild ? a._node.insertBefore(this._node, a._node.firstChild) : a._node.appendChild(this._node));
        },
        attr: function (e, t) {
      ...
      n.Bar = n.Base.extend({
        ...
        createChart: function (e) {
          ...
          c = e.distributeSeries && e.stackBars ? t.normalized.labels.slice(0, 1) : t.normalized.labels, e.horizontalBars ? (l = d = void 0 === e.axisX.type ? new n.AutoScaleAxis(n.Axis.units.x, t.normalized.series, h, n.extend({}, e.axisX, {
            ...
            ticks: c
          }) : e.axisX.type.call(n, n.Axis.units.x, t.normalized.series, h, e.axisX), l = p = void 0 === e.axisY.type ? new n.AutoScaleAxis(n.Axis.units.y, t.normalized.series, h, n.extend({}, e.axisY, {
            highLow: o,
            referenceValue: 0
        ...
        createChart: function (e) {
          ...
          l.raw.series.forEach(function (e, t) {
            ...
            if (0 !== l.normalized.series[a] || !e.ignoreEmptyValues) {
              c[a].attr({
                "ct:series-name": r.name
              }), c[a].addClass([e.classNames.series, r.className || e.classNames.series + "-" + n.alphaNumerate(a)].join(" "));
  ...
  function c(e) {
    ...
    }, !!u && r.default.createElement(a.Icon, {
      name: u,
      className: l("icon", c)
  ...
  c.propTypes = {
    ...
    active: !1
  }, c.displayName = "ToggleSwitch", t.default = c;
}, function (e, t) {
  e.exports = {
