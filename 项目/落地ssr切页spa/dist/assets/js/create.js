...
const BooksCreateNode = new BooksCreate(); // Because the foo template indicated it was to be automatically rendered, its content is already present in your element instance.

exports.default = BooksCreateNode; // BooksCreateNode.render();